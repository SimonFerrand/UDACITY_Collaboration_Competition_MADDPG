...
class Agent():
    ...
    def __init__(self, state_size, action_size, n_agents, random_seed, episodes):
        ...
        self.NOISE_DECAY_EPISODES_TO_MIN_SIGMA = config.NOISE_DECAY_EPISODES_TO_MIN_SIGMA  # Number of episodes to reach SIGMA min 
        ...
        self.noise = OUNoise(action_size, random_seed, noise_sigma_initial=self.NOISE_SIGMA_INITIAL, noise_decay_episodes_to_min_sigma=self.NOISE_DECAY_EPISODES_TO_MIN_SIGMA, min_noise_sigma=self.NOISE_SIGMA_MIN) 
...
class OUNoise:
    ...
    def __init__(self, size, seed, noise_sigma_initial, noise_decay_episodes_to_min_sigma , min_noise_sigma, mu=0., theta=0.15):
    ...
    def reset(self,i_episode):
        ...
        self.noise_decay_rate_calculated = (self.min_noise_sigma / self.noise_sigma_initial) ** (1 / self.noise_decay_episodes_to_min_sigma)
        self.sigma = max(self.noise_sigma_initial * (self.noise_decay_rate_calculated ** i_episode), self.min_noise_sigma) # This value would be updated at the end of each episode
